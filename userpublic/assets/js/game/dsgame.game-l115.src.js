...
(function(host, name, Event, undefined){
    var ConfigData =gameConfigData,
        ...
        //ConfigData['jsPath'] = ConfigData['jsPath'].replace('ssc', 'l115');
...
(function(host, name, GameMethod, undefined) {
	var defConfig = {
			...
			//单式玩法提示
			normalTips:['说明：',
				'1、每一注号码之间的间隔符支持 回车 逗号[,] 分号[;] 冒号[:] 竖线 [|] 每注内间隔使用空格即可。',
...
$(function(){
	 ...
	 *实例化个方法模块
	 */
	dsgame.Games.L115.getInstance({'jsNameSpace': 'dsgame.Games.L115.'});//游戏实例
	...
	dsgame.Games.L115.Message.getInstance();//消息类
