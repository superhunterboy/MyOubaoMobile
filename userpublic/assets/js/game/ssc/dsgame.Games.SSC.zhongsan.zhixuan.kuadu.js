		...
		miniTrend_createRowHtml:function(){
			...
			$.each(data, function(i){
				...
				html.push('<tr class="'+ trcls +'">');
					...
					xtText = Math.max(parseInt(number[1]), parseInt(number[2]), parseInt(number[3])) - Math.min(parseInt(number[1]), parseInt(number[2]), parseInt(number[3]));
