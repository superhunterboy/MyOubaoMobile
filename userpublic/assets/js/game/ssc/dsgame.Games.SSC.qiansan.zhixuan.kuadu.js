		...
		miniTrend_createRowHtml:function(){
			...
			$.each(data, function(i){
				...
				html.push('<tr class="'+ trcls +'">');
					...
					xtText = Math.max(parseInt(number[0]), parseInt(number[1]), parseInt(number[2])) - Math.min(parseInt(number[0]), parseInt(number[1]), parseInt(number[2]));
