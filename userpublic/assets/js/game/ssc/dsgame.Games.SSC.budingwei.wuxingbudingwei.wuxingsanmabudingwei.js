...
(function(host, GameMethod, undefined){
	var defConfig = {
		name:'budingwei.wuxingbudingwei.wuxingsanmabudingwei'
	...
	var pros = {
		...
		randomNum: function(){
			...
			original = [[lotterys[0][0], lotterys[0][1], lotterys[0][2]]];
	...
	var html_row = [];
		html_row.push('<li>');
		html_row.push('<div class="ball-title"><strong><#=title#>不定位</strong><span></span></div>');
