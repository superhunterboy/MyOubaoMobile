...
(function(host, GameMethod, undefined){
	...
	var html_row = [];
		...
		html_row.push('<ul class="ball-content">');
			$.each([11,22,33,44,55,66], function(i){
	...
	var html_row1 = [];
		html_row1.push('<li>');
		html_row1.push('<div class="ball-title"><strong><#=title#></strong><span></span></div>');
		html_row1.push('<ul class="ball-content">');
			$.each([1,2,3,4,5,6], function(i){
				html_row1.push('<li><a href="javascript:void(0);" data-param="action=ball&value='+ i +'&row=<#=row#>" class="ball-number">'+this+'</a></li>');
			});
		html_row1.push('</ul>');
		html_row1.push('</li>');
