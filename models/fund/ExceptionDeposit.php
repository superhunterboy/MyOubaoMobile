...
//        pr($this->validationErrors);
    ...
    public function setAccected($iAdminUserId) {
        ...
        return self::where('id', '=', $this->id)->where('status', '=', self::EXCEPTION_DEPOSIT_STATUS_EXCEPTION)->update($data) > 0;
    }
    ...
    public function setVerifyAccected($iAdminUserId) {
        ...
        return self::where('id', '=', $this->id)->whereIn('status', [self::EXCEPTION_DEPOSIT_STATUS_WAITING_VERIFY])->update($data) > 0;
    }
