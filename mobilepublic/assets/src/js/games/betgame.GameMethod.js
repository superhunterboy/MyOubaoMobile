...
(function(host, name, Event, undefined) {
	...
	var pros = {
		...
		exeEvent_cancelCurrentButton: function(x, y, v) {
			...
			control.find('>[data-param]').removeClass('current');
		},
		//选球事件
		...
		//切换或更新走势图
		miniTrend_updateTrend:function(issues){
			var me = this,
				tbody = me.miniTrend_getTrendTable().find('tbody');

			issues && me.miniTrend_setBallsData(issues);
		...
		miniTrend_setBallsData: function(issues){
			this.miniTrendData = issues;
		},
		//获取最新的开奖数据
...
})(betgame, "GameMethod", betgame.Event);
