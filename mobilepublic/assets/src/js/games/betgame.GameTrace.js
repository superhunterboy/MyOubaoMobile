...
(function(host, name, Event, undefined){
	...
	var pros = {
		...
		initEvent:function(){
			...
			me.panel.find('.chase-table').blur(function(e){
			...
			//追号期数输入限制
			$('#J-trace-lirunlv-times').blur(function(){
				this.value = me.getTimes(me.getTraceType());
			});
			$('#J-trace-tongbei-times').blur(function(){
				this.value = me.getTimes(me.getTraceType());
			});
			$('#J-trace-fanbei-times').blur(function(){
				this.value = me.getTimes(me.getTraceType());
			});
...
})(betgame, "GameTrace", betgame.Event);
