...
return array(
    ...
    */
    ...
    'custom' => array(),
    "different_before_hash"  => ":attribute 和 :other 不能相同。",
    "custom_password"        => ":attribute 需由字母和数字组成的6-16个字符；且必须同时包含字母和数字，不允许连续三位相同",
    "custom_admin_password"  => ":attribute 需由字母和数字组成的8-16个字符；且必须同时包含字母和数字，不允许连续三位相同",
    "custom_first_character" => ":attribute 首字符必须是英文字母",
