...
$modalData2['modal'] = [
    'id' => 'black-list',
    'title' => __('_bankcard.black-list-title'),
    'action' => 'black',
    'method' => 'post',
    'message' =>
    join('', [
...
$modalData3['modal'] = [
    'id' => 'inuse-status',
    'title' => __('_bankcard.inuse-title'),
    'action' => 'inuse',
    'method' => 'post',
    'message' =>
    join('', [
...
<script>
    ...
    function setToBlackList(href)
    {
        $('#black').attr('action', href);
        $('#black-list').modal();
    }
    function setToInUseStatus(href)
    {
        $('#inuse').attr('action', href);
        $('#inuse-status').modal();
    }
