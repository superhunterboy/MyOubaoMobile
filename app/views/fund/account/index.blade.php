...
<div class="col-md-12">
    ...
    <div>
        <div class='alert alert-danger'>
            总余额：{{number_format(array_get($sumInfo, 'total_balance'),2)}}&nbsp;&nbsp;&nbsp;
            总冻结余额：{{number_format(array_get($sumInfo, 'total_frozen'),2)}}&nbsp;&nbsp;&nbsp;
            总可用余额：{{number_format(array_get($sumInfo, 'total_available'),2)}}&nbsp;&nbsp;&nbsp;
            总不可提现余额：{{number_format(array_get($sumInfo, 'total_prohibit_amount'),2)}}
        </div>
        <div class=" time-top">
