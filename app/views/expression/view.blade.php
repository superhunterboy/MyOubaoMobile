...
<form method="GET" action="###" accept-charset="UTF-8" class="form-horizontal">
    <table class="table table-bordered table-striped">
        <tbody>
             <tr>
                <th  class="text-right col-xs-2">缩写：</th>
                <td>{{$oExpression->identifier}}</td>
            </tr>
             <tr>
                <th  class="text-right col-xs-2"> 描述：</th>
                <td>{{$oExpression->description}}</td>
            </tr>
            <tr>
                <th  class="text-right col-xs-2"> 表达式：</th>
                <td>
