...
<body class="table-trend">
	...
	<div class="header">
		<div class="header-inner">
			<ul>
				<li class="current"><a href="/tides/trend-view/2">山东11选5</a></li>
                <li><a href="/tides/trend-view/3">黑龙江时时彩</a></li>
                <li><a href="/tides/trend-view/5">江西时时彩</a></li>
                <li><a href="/tides/trend-view/6">新疆时时彩</a></li>
                <li><a href="/tides/trend-view/7">天津时时彩</a></li>
                <li><a href="/tides/trend-view/8">江西11选5</a></li>
                <li><a href="/tides/trend-view/9">广东11选5</a></li>
                <li><a href="/tides/trend-view/10">重庆11选5</a></li>
                <li><a href="/tides/trend-view/11">3D</a></li>
                <li><a href="/tides/trend-view/12">排列五</a></li>
                <li><a href="/tides/trend-view/13">CC彩票分分彩</a></li>
                <li><a href="/tides/trend-view/14">CC彩票11选5</a></li>
			</ul>
		</div>
	</div>
	<div class="select-section">
		<div class="select-section-inner clearfix">
			<ul class="select-list">
				...
				<li class="current"><a href="ssc_houer.php">后二</a></li>
			</ul>
	...
	<div class="select-section-content clearfix" id="J-panel-control">
		<div class="select-section-content-inner">
			...
			<div class="search">
				...
				<a id="J-time-periods" class="btn btn-important" href="javascript:void(0);">搜索</a>
			</div>
		</div>
	</div>
