	...
	<div class="main-content">
		...
		<div class="nav-bg nav-bg-tab">
			...
			<ul class="tab-title clearfix">
				<li class="current"><a href="records-game.php"><span>游戏记录</span></a></li>
				<li><a href="records-trace.php"><span>追号记录</span></a></li>
			</ul>
		</div>
			...
			<table width="100%" class="table" id="J-table">
				...
				<tbody>
					<tr>
						...
						<td><span data-money-format>30.0000</span></td>
						<td><span data-money-format>0.0000</span></td>
				...
				<tfoot>
					<tr>
						...
						<td></td>
						<td></td>
						<td><span data-money-format>1,800.0000</span></td>
						<td><span data-money-format>1,800.0000</span></td>
						<td></td>
					</tr>
				</tfoot>
...
(function($){
	...
	selectPeriod.addEvent('change', function(e, value, text){
		// selectPeriod.getRealDom().parants(0).find('[type="button"]').trigger('click');
	});
