...
var dsAvatarPath = '/assets/images/global/avatar/';
...
;(function($){
	...
	F.prototype = {
		...
		// debug
		debug: function(){
			// this.debugs && window.console && console.log && console.log( '[eventsPush] ' + Array.prototype.join.call(arguments, ' ') );
...
$(function() {
	...
	$('[data-event-push]').eventsPush({
		eventsData: [{
			...
			title: '大圣见面礼，新用户来就送38元！',
			link: '/events/registgetmoney'
		}]
	});
