...
(function(host, GameMethod, undefined){
	var defConfig = {
		name:'yixing.dingweidan.sanxingdingweidan',
		//玩法提示
		tips:'一星定位胆复式玩法提示',
		//选号实例
	...
	var html_head = [];
		//头部
		html_head.push('<div class="number-select-title balls-type-title clearfix"><div class="number-select-link"><a href="" class="pick-rule">选号规则</a><a href="" class="win-info">中奖说明</a></div><div class="function-select-title"><a href="javascript:void(0);" class="current">遗漏</a><a href="javascript:void(0);">冷热</a></div></div>');
