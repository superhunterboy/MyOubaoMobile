	...
	var pros = {
		...
		line: function(Mx, My, Lx, Ly) {
			...
			setTimeout(function() {
				...
				if (lastLeft > left) {
					saveNum = me.mathNum(width, 0, 0, height, 7.5);
				} else {
					saveNum = me.mathNum(0, 0, width, height, 7.5);
				}
...
})(dsgame, "GameCharts", dsgame.Event);