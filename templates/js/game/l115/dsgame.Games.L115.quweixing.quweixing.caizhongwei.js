(function(host, Danshi, undefined) {
    var defConfig = {
            name: 'quweixing.quweixing.caizhongwei',
            //父容器
    ...
    html_row.push('<ul class="ball-content" style="padding-left:110px;">');
    $.each([2,3,4,5,6,7,8,9], function(i) {
        if(i == 0){
