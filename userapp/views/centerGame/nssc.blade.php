...
@section ('container')
	...
	<div class="dice-wrap">
		...
		<div class="dice-panel">
			...
			<div class="shortcuts">
				<a href="/help/7#108" target="_blank">游戏规则</a>
				<a href="{{route('bets.betform', 1)}}">切换重庆时时彩</a>
			</div>
			...
			<div class="lottery-number">
				<div class="show-balls-number">
					<b id="show-balls-number"></b>期开奖号码
				</div>
				<div id="flipball"></div>
			</div>
	...
	<div class="game-history-wrap">
		<div class="game-history">
			...
			<div class="history-content">
				<iframe id="record-iframe" src="{{route('projects.mini-window', 17)}}" width="100%" height="220px" frameborder="0"></iframe>
			</div>
		</div>
	</div>
</div>
...
{{ script('dsgame.Gamedices.NSSC.Config')}}
