...
<div class="nav-bg nav-bg-tab">
    ...
    <div class="content">
        @if (Session::get('is_agent'))
            @include('centerUser.profit._agent_search')
            @include('centerUser.profit._agent_table')

        @else
            @include('centerUser.profit._user_search')
            @include('centerUser.profit._user_table')
        @endif
