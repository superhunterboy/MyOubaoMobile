...
@include('widgets.data.' . $aSelectorData['sDataFile']);
        ...
        var renderFirstSelector = function ()
        {
            ...
            firstSelect  = new dsgame.Select({realDom:'#J-select-1',cls:'w-3'});
        }
        /**
        ...
        var renderSecondSelector = function (first_id)
        {
            ...
            secondSelect = new dsgame.Select({realDom:'#J-select-2',cls:'w-3', valueKey: 'id', textKey: 'name'});
        }
        /**
        ...
        var renderThirdSelector = function (second_id)
        {
            ...
            thirdSelect = new dsgame.Select({realDom:'#J-select-3',cls:'w-3', valueKey: 'id', textKey: 'name'});
        }
        // 初始化彩种下拉框
        renderFirstSelector();
        // 初始化时，如果有彩种初始值，则填充玩法群下拉框，否则初始化dsgame.Select对象
        if (selectedFirst) {
        ...
        // 初始化时，如果有玩法群初始值，则填充玩法下拉框，否则初始化dsgame.Select对象
        if (selectedSecond) {
