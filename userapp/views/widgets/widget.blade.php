...
@include('widgets.data.' . $aSelectorData['sDataFile']);
     ...
     */
        ...
        var renderFirstSelector = function ()
        {
            ...
            firstSelect  = new dsgame.Select({realDom:'#J-select-1',cls:'w-3', valueKey: 'id', textKey: 'name', scrollHeight:247});
        }
        var renderSecondSelector = function (first_id)
        {
            ...
            secondSelect = new dsgame.Select({realDom:'#J-select-2',cls:'w-3', valueKey: 'id', textKey: 'name', scrollHeight:247});
        }
        renderFirstSelector();
